...
const CustomModal = ({ isOpen, title = 'My Modal', onDismiss, children }: IProps) => {
	if (!isOpen) {
		return null;
	}
	...
	return (
		<div
			...
			onClick={onDismiss}>
			<div
				className='mt-14 lg:mt-10 min-w-[400px] max-w-full overflow-x-hidden min-h-[200px] max-h-[90vh] bg-white rounded-xl p-2 flex flex-col relative'
