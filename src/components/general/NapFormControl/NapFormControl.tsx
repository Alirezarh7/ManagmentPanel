...
function useFormControl(iRules: any): any {
    ...
    function onChangeHandler(event: any) {
        const val: any = { ...values }
        val[event.target.name] = computingValue(rules[event.target.name],event.target.type === 'checkbox' ? event.target.checked : event.target.value);
        setValuesState(val)
        let errors: any = { ...validationErrors }
    ...
    return { values, onChangeHandler, onFormSubmit, GetError, GetRequired, GetValue, setInitialValues, resetForm, setValue, setValues }
}
