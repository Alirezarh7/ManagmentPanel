...
type IProps = typeof reserveAndRegisterActions & IReserveAndRegisterState & IInternalProps;
const ModalPeyment = (props: IProps) => {
						...
						<div className={'import-modal-body-reserve '}>
							...
							<div className='w-full flex justify-center'>
								<p>
									...
									بیت) عصمت و طهارت علیهم السلام، و بر اساس برنامه ریزی های انجام شده ثبت‌نام از واجدین شرایط و متقاضیان اعزام به
									حج تمتع سال 1403 در کاروان‌های سراسر کشور را از ساعت 10:00 صبح روز یک‌شنبه 06/12/1402 ضمن رعایت موارد مشروح زیر
									آغاز می‌نماید:
								</p>
							</div>
							<ul className={'notice-list'}>
								...
								<li>
									...
									داشت، لیکن درصورت عدم مراجعه ایشان در بازه زمانی یاد شده و وجود ظرفیت خالی پس از پایان تاریخ مقرر، باقیمانده
									ظرفیت کاروان ها با فراخوان از اولویت های بعدی تکمیل خواهد شد.
								</li>
							</ul>
							...
							<p>
								...
								به دفتر مدیر کاروان‌ مراجعه و سایر مراحل ثبت‌نام (تحویل مدارک، انجام معاینات،اخذ تأییدیه پزشکی) را پیگیری نمایند.
							</p>
							<ul className={'notice-list'}>
								...
								<p className='mt-4'>
									...
									اعلام خواهد شد؛ تأکید می‌گردد ضروری است نسبت به آماده‌سازی گذرنامه معتبر و عکس از هم اکنون اقدام گردد. ضمناً
									تمامی متقاضیان اعزام برای سفر حج تمتع سال 1403می‌بایست دارای گذرنامه حداقل با تاریخ اعتبار1403/09/20 باشند.
								</p>
								...
								<p>
									...
									کاروان تعیین شده ‌است. ضروری است پس از انتخاب کاروان مورد نظر، مبلغ باقیمانده هزینه سفر حداکثر ظرف یک هفته از
									طریق سامانه‌ حج و زیارت به نشانی my.haj.ir پرداخت گردد.
								</p>
							</ul>
							...
							<ol>
								...
								<li>
									...
									سفر تلقی شده و ثبت نام وی در کاروان بصورت یک طرفه و سیستمی ابطال می‌گردد و درصورت تمایل به ثبت نام مجدد می
									بایست، مراحل را مجدداً در سایر ظرفیت های خالی دنبال نماید.
								</li>
								<li>
									متقاضیان محترم، می بایست پس از اعلام مدیر کاروان به پزشک و یا مراکز پزشکی که از سوی ایشان معرفی می‌گردد، مراجعه
									و درصورت تأیید سلامت و توان جسمی، مراحل نهایی سفر خود را دنبال نمایند؛ بدیهی است درصورت عدم مراجعه به موقع به
									پزشک و انجام معاینات مربوطه و یا عدم تأیید استطاعت بدنی، فرآیند ثبت‌ نام و اعزام متوقف و سایر افراد حائز شرایط
									جایگزین خواهند شد.
								</li>
								<li>
...
)(ModalPeyment as ComponentType<any>);
