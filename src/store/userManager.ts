...
const userManager = localStorage.getItem(shareData.CONSTANT.SSO_APPROACH) === 'mygov' ? createUserManager(userManagerConfigGov) : createUserManager(userManagerConfigOrganization);
