			...
			<div className='card'>
				<div className={`more__info  ${isShowMoreInfo ? 'show__more__info' : 'more__info '}`}>
					<ul className='card__info__more'>
						...
						{/* <li>
                            <span className="card__more__info__stats">{props.props && props.props.branchCode ? props.props.branchCode : "---"}</span>
                            <span className={"card__more__info__title"}> کد شعبه:</span>
                        </li>
                        <li>
                            <span className="card__more__info__stats">{props.props && props.props.zaerNumber ? props.props.zaerNumber : "---"}</span>
...
export default connect((state: IApplicationState) => state.reserveAndRegister, registrationActions)(Card);
